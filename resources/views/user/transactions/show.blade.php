                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                        <div class="col-md-10">
                            ...
                            <div class="alert alert-custom alert-notice alert-light-danger fade show" role="alert">
                                ...
                                <div class="alert-text">Silahkan konfirmasi pembayaran ke <a href="https://wa.me/{{setting('whatsapp_number')}}" target="_blank">whatsapp</a> kami maksimal 1x24 jam setelah melakukan checkout.</div>
