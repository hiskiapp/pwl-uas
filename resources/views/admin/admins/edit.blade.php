...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <!--begin::Form-->
        <form class="form" id="kt_form" method="POST" action="{{ route('admin.admins.update', $admin->id) }}">
            @method('PATCH')
            @csrf
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control form-control-solid @error('name') is-invalid @enderror"
                                    type="text" name="name" value="{{ old('name', $admin->name) }}" required
                                    autocomplete="off" />
                                @error('description')
                        ...
                        <div class="my-52">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <button type="button"
                                        class="btn btn-light-danger font-weight-bold btn-sm btn-destroy" data-id="{{ $admin->id }}">Delete this
                                        account
                                        ?</button>
                                    <div class="form-text text-muted mt-3">Perhatian: Anda tidak bisa mengembalikannya seperti semula.
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
{{-- page scripts --}}
<script src="{{ asset('js/pages/admin/admins/edit.js') }}" type="text/javascript"></script>
@endsection
